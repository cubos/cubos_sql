...
//!
//! The analyzer produces a [`cubos_sql_analyzer::Type`] that describes a
...
//! `[package.metadata.cubos_sql.{domains, enums, types}]` take precedence
//! over these tables.

/// Built-in PostgreSQL types, keyed by `(schema, pg_name)`.
///
/// Schema is always `pg_catalog` for true built-ins. Arrays are NOT listed
/// here — they are resolved generically via [`cubos_sql_analyzer::Type::Array`]
...
/// analyzer's [`cubos_sql_analyzer::Type::Basic`] (and friends) `extension`
