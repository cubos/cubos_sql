...
pub fn expand(input: DeriveInput) -> Result<TokenStream, syn::Error> {
    ...
    Ok(quote! {
        impl #impl_generics cubos_sql::FromRow for #name #ty_generics #where_clause {
            fn from_row(__row: &::cubos_sql::__private::tokio_postgres::Row) -> ::std::result::Result<Self, cubos_sql::Error> {
