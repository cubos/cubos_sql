...
//! 1. Add `.sql` files to `pgsafe_analyzer/src/extensions/`
...
// SQL files are in pgsafe_analyzer/src/extensions/ and fetched via
    ...
    let ext = REGISTRY
        ...
        .ok_or_else(|| {
            DdlError::ExtensionError(format!(
                "unknown extension '{name}': add a SQL file to pgsafe_analyzer/src/extensions/ \
