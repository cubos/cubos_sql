...
use chrono::Utc;
use clap::Parser;
use pgsafe::migrate::{self, MigrationSource};
use pgsafe_core::config::Config;
...
#[derive(Parser)]
#[command(name = "cargo", bin_name = "cargo", about = "pgsafe database tools")]
struct Cli {
    #[command(subcommand)]
