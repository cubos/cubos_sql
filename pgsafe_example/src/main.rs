//! Example demonstrating pgsafe with static analysis.
//!
...
//!
//! To build: `cargo build -p pgsafe_example`
...
#[allow(dead_code)]
async fn example_queries(pool: &deadpool_postgres::Pool) -> Result<(), pgsafe::Error> {
...
fn main() {
    println!("pgsafe_example compiled successfully!");
