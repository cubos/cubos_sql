...
pub fn expand(input: DeriveInput) -> Result<TokenStream, syn::Error> {
    ...
    Ok(quote! {
        impl #impl_generics pgsafe::FromRow for #name #ty_generics #where_clause {
            fn from_row(__row: &::pgsafe::__private::tokio_postgres::Row) -> ::std::result::Result<Self, pgsafe::Error> {
